...
/**
 * The persistent class for the risk_severity_lv database table.
 * 
 */
@Entity
@Table(name="risk_severity_lv")
@NamedQuery(name="RiskSeverityLv.findAll", query="SELECT r FROM RiskSeverityLv r")
public class RiskSeverityLv implements Serializable {
	...
	@OneToMany(mappedBy="riskSeverityLv")
	private List<RiskBase> riskBases;

	public RiskSeverityLv() {
	}
	...
	public RiskBase addRiskBas(RiskBase riskBas) {
		...
		riskBas.setRiskSeverityLv(this);
	...
	public RiskBase removeRiskBas(RiskBase riskBas) {
		...
		riskBas.setRiskSeverityLv(null);
