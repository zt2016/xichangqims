...
/**
 * The persistent class for the risk_probability_lv database table.
 * 
 */
@Entity
@Table(name="risk_probability_lv")
@NamedQuery(name="RiskProbabilityLv.findAll", query="SELECT r FROM RiskProbabilityLv r")
public class RiskProbabilityLv implements Serializable {
	...
	@OneToMany(mappedBy="riskProbabilityLv")
	private List<RiskBase> riskBases;

	public RiskProbabilityLv() {
	}
	...
	public RiskBase addRiskBas(RiskBase riskBas) {
		...
		riskBas.setRiskProbabilityLv(this);
	...
	public RiskBase removeRiskBas(RiskBase riskBas) {
		...
		riskBas.setRiskProbabilityLv(null);
