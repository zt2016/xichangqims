...
/**
 * The persistent class for the risk_impact_lv database table.
 * 
 */
@Entity
@Table(name="risk_impact_lv")
@NamedQuery(name="RiskImpactLv.findAll", query="SELECT r FROM RiskImpactLv r")
public class RiskImpactLv implements Serializable {
	...
	@OneToMany(mappedBy="riskImpactLv")
